...
<form method="post" action="?url=proses-tambah-pembayaran&nisn=<?= $nisn; ?>">
    ...
    <div class="form-group mb-2">
        ...
        <input value="<?= $_SESSION['nama_petugas'] ?>" readonly class="form-control"required>
</div>
<div class="form-group mb-2">
    <label>NISN</label>
...
<div class="form-group mb-2">
    <label>Nama Siswa</lebel>
    <input disabled value="<?= $data['nisn'] ?>" type="text" class="form-control" required>
</div>
<div class="form-group mb-2">
   <label>Tanggal Bayar</label>
   <input type="date" name="tgl_bayar" from_control" required>
</div>
<div class="from-group mb-2">
   ...
   <div class="form-group mb-2">
    <label>Jumlah Bayar (Jumlah yang harus di bayar adalah <b><?= number_format($kekurangan,2,',','.')?></b>)</lebel>
    <input type="number" name="jumlah_bayar" max="<?= $kekurangan; ?>" class="form-control" required>
</div>
<div class="form-group">
    <button type="sumbit" class="btn btn-succes"> SIMPAN </button>
